...
const CATEGORY_TILE_STYLE: Record<string, string> = {
  ...
  'Content & Social': 'bg-rose-50 hover:bg-rose-50 dark:bg-rose-900/15 dark:hover:bg-rose-900/25 border-rose-100 dark:border-rose-600',
...
const CATEGORY_HOVER_TEXT: Record<string, string> = {
  ...
  'Content & Social': 'hover:text-rose-600 dark:hover:text-rose-300',
...
const CATEGORY_HOVER_BORDER: Record<string, string> = {
  ...
  'Content & Social': 'hover:border-rose-200 dark:hover:border-rose-600',
