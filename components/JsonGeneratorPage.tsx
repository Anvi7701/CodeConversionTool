...
const CATEGORY_TILE_STYLE: Record<string, string> = {
  ...
  'Content & Social': 'bg-violet-50 hover:bg-violet-50 dark:bg-violet-900/15 dark:hover:bg-violet-900/25 border-violet-100 dark:border-violet-600',
...
const CATEGORY_HOVER_TEXT: Record<string, string> = {
  ...
  'Content & Social': 'hover:text-violet-600 dark:hover:text-violet-300',
...
const CATEGORY_HOVER_BORDER: Record<string, string> = {
  ...
  'Content & Social': 'hover:border-violet-200 dark:hover:border-violet-600',
